      ...
      <div class="col-lg-4 order-lg-2">
        ...
        <div class="card shadow mb-4">
          <div class="card-profile-image mt-4 text-center">
            <img width="180px" class="img-profile rounded-circle" src="{{ isset(auth()->user()->image) ? auth()->user()->image : '/assets/guest.jpeg' }}">
            {{-- <figure class="rounded-circle avatar avatar font-weight-bold"
              style="font-size: 60px; height: 180px; width: 180px;" data-initial="{{ Auth::user()->first_name }}"></figure> --}}
          </div>
          <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group focused">
                      ...
                      <input type="text" id="name" class="form-control" name="name" placeholder="Last name"
